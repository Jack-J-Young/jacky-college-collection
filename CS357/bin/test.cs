...
// Command Line Options: x:\repos\jacky-college-collection\CS357\Lab 2\test.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\test
// test.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void Eg(BigInteger z, out BigInteger x, out BigInteger y)
    {
      x = BigInteger.Zero;
      y = BigInteger.Zero;
      x = new BigInteger(6);
